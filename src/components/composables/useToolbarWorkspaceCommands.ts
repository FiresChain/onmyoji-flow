...
export function useToolbarWorkspaceCommands(options: UseToolbarWorkspaceCommandsOptions) {
  const { filesStore, logicFlowScope, showMessage, refreshLogicFlowCanvas } = options;
