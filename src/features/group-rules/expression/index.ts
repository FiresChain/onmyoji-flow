...
export type CompiledRuleExpression = ExpressionNode;
...
export const compileRuleExpression = parseRuleExpression;

export const evaluateCompiledRuleExpression = (
  expression: CompiledRuleExpression,
  scope: RuleExpressionScope,
  ...
  return evaluateNode(expression, scope, state);
};
...
export const evaluateRuleExpression = (
  ...
  return evaluateCompiledRuleExpression(
    compileRuleExpression(source),
    scope,
    options,
  );
};
